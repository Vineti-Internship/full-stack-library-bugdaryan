...
leila = Author.create(username:'leila', name:'leila', email:'leila@mail.com', password:'123456', password_confirmation:'123456')
peter = Author.create(username:'peter', name:'peter', email:'peter@mail.com', password:'123456', password_confirmation:'123456')
fleur = Author.create(username:'fleur', name:'fleur', email:'fleur@mail.com', password:'123456', password_confirmation:'123456')
john  = Author.create(username:'john',  name:'john',  email:'john@mail.com',  password:'123456', password_confirmation:'123456')
